...
- l'utilisation de requêtes préparées PDO pour éviter les injections SQL
- l'utilisation de htmlspecialchars() pour empêcher les attaques XSS
- l'ajout d’un jeton CSRF dans le formulaire
- la limitation de l’affichage des erreurs SQL pour éviter la divulgation d’informations sensibles
